...
/**
 * Represents a vault service adapter wrapping a [ServiceHub] instance.
 *
 * @param serviceHub The [ServiceHub] instance which will be used to query or track the vault.
...
internal class VaultAdapterServiceHub<T : ContractState>(
    ...
    override fun queryBy(
        ...
        return serviceHub.vaultService.queryBy(contractStateType, criteria, paging, sorting)
    }
    ...
    override fun trackBy(
        ...
        return serviceHub.vaultService.trackBy(contractStateType, criteria, paging, sorting)
    }
}
