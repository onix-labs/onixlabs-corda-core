...
import io.onixlabs.corda.test.workflow.RevokeCustomerFlow
import net.corda.core.transactions.SignedTransaction
import org.junit.jupiter.api.Test
import org.junit.jupiter.api.fail
import kotlin.test.assertEquals

class RevokeCustomerFlowTests : FlowTest() {
    ...
    override fun initialize() {
        Pipeline
            ...
            .run(nodeA) {
                ...
                RevokeCustomerFlow.Initiator(issuedCustomer, observers = setOf(partyB, partyC))
            }
            .finally {
                transaction = it
            }
